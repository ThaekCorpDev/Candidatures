...
$candids = json_encode($model->find(['where' => ['request' => 'state=1', 'datas' => []]]));
...
<div ng-repeat="candid in candids | filter:search">
	...
	<a href="state/accept.php?id={{candid.id}}"><button class="btn btn-success">Accepter</button></a>
	<a href="state/refuse.php?id={{candid.id}}"><button class="btn btn-danger">Refuser</button></a>
	<a href="state/default.php?id={{candid.id}}"><button class="btn btn-warning">Dépréaccepter</button></a>
	<hr>
</div>
